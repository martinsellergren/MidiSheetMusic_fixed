...
public class MidiPlayer extends LinearLayout {
    ...
    static Bitmap menuImage;  /** Menu-button image */
    ...
    private ImageButton fastFwdButton;/** The fast fKorward button */
    private ImageButton menuButton;/** FIX: Menu-button */
    ...
    SheetMusicActivity sheetMusicActivity; /** My fix for calling menu */
    ...
    public static void LoadImages(Context context) {
        ...
        menuImage = BitmapFactory.decodeResource(Resources.getSystem(), android.R.drawable.ic_menu_preferences);
    }
     ...
     */
    public MidiPlayer(SheetMusicActivity sma) {
        super(sma);

        sheetMusicActivity = sma;
        context = sma;
        LoadImages(context);
        this.midifile = null;
        this.options = null;
